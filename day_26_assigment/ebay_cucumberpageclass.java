...
//		Thread.sleep(10000);
		driver.findElement(By.id("userid")).sendKeys("rohitch1418@gmail.com");
		driver.findElement(By.id("signin-continue-btn")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("pass")).sendKeys("Rohith@123");
...
//		sfn.click();
	...
	public void changeAddressAndName() throws InterruptedException 
	{
	    ...
	    streetAddress.clear();
	    streetAddress.sendKeys("Ayyappa society, Madhapur");
	    Thread.sleep(1000);
